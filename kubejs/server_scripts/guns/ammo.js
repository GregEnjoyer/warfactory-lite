...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('kubejs:sw_claymore_mine')
        .itemInputs(Item.of('gtceu:aluminium_plate', 4), Item.of('gtceu:dynamite', 2), Item.of('gtceu:good_integrated_circuit', 2))
        .itemOutputs(Item.of('superbwarfare:claymore_mine', 1))
        .circuit(1).duration(100).EUt(32);

    // Entry Denial Device
    event.recipes.gtceu.assembler('kubejs:sw_edd')
        .itemInputs(Item.of('gtceu:aluminium_plate', 8), Item.of('gtceu:dynamite', 4), Item.of('gtceu:good_integrated_circuit', 2))
    ...
    event.recipes.gtceu.assembler('kubejs:sw_dragon_teeth')
        .itemInputs(Item.of('gtceu:double_stainless_steel_plate', 4), Item.of('gtceu:dynamite', 16), Item.of('gtceu:micro_processor_assembly', 2))
    ...
    event.recipes.gtceu.assembler('kubejs:sw_c4_bomb')
        .itemInputs(Item.of('gtceu:stainless_steel_plate', 8), Item.of('gtceu:dynamite', 6), Item.of('gtceu:micro_processor_assembly', 1))
        .itemOutputs(Item.of('superbwarfare:c4_bomb', 1))   // <- replace with actual NBT string you captured
        .circuit(4).duration(300).EUt(512);

    event.recipes.gtceu.assembler('kubejs:sw_c4_bomb_remote')
        .itemInputs(Item.of('gtceu:stainless_steel_plate', 8), Item.of('gtceu:dynamite', 6), Item.of('gtceu:micro_processor_assembly', 1))
        .itemOutputs(Item.of('superbwarfare:c4_bomb', 1, '{Control:1b}'))   // <- replace with actual NBT string you captured
        .circuit(9).duration(300).EUt(512);
        
    // TM-62 anti-tank mine — HE fill, heavy pressure plate
    event.recipes.gtceu.assembler('kubejs:sw_tm_62')
        .itemInputs(Item.of('gtceu:double_stainless_steel_plate', 8), Item.of('gtceu:micro_processor_assembly', 4), Item.of('gtceu:dynamite', 8), Item.of('gtceu:small_steel_spring', 4))
        .itemOutputs(Item.of('superbwarfare:tm_62', 1))
        .circuit(2).duration(600).EUt(512);
