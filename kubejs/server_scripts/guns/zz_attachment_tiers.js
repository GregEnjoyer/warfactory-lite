...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('attachment_tier_muzzle_lv_tacz_muzzle_brake_cthulhu')
        .itemInputs([Item.of('kubejs:barrel_steel', 1), Item.of('gtceu:steel_ring', 1), '1x #forge:plates/polyethylene'])
    ...
    event.recipes.gtceu.assembler('attachment_tier_muzzle_hv_tacz_muzzle_brake_timeless50')
        .itemInputs([Item.of('kubejs:barrel_damascus', 1), Item.of('gtceu:stainless_steel_ring', 1), '1x #forge:plates/polytetrafluoroethylene', Item.of('gtceu:stainless_steel_gear', 1)])
    ...
    event.recipes.gtceu.assembler('attachment_tier_suppressor_ww_ww_silence')
        .itemInputs([Item.of('gtceu:steel_screw', 3), Item.of('gtceu:steel_rod', 1), '1x #forge:plates/polyethylene'])
    ...
    event.recipes.gtceu.assembler('attachment_tier_suppressor_mv_tacz_muzzle_silencer_knight_qd')
        .itemInputs([Item.of('gtceu:steel_screw', 4), Item.of('gtceu:aluminium_rod', 1), '1x #forge:plates/polyvinyl_chloride', Item.of('gtceu:small_aluminium_gear', 1)])
    ...
    event.recipes.gtceu.assembler('attachment_tier_sight_reflex_tacz_sight_acro_pistol')
        .itemInputs([Item.of('gtceu:glass_lens', 1), Item.of('gtceu:steel_screw', 1), Item.of('gtceu:aluminium_rod', 1), '1x #forge:plates/polyvinyl_chloride', '1x #gtceu:circuits/mv'])
    ...
    event.recipes.gtceu.assembler('attachment_tier_sight_holo_tacz_sight_552')
        .itemInputs([Item.of('gtceu:glass_lens', 1), Item.of('gtceu:steel_screw', 2), Item.of('gtceu:stainless_steel_rod', 1), '1x #forge:plates/polytetrafluoroethylene', '1x #gtceu:circuits/hv'])
    ...
    event.recipes.gtceu.assembler('attachment_tier_scope_basic_tacz_scope_1873_6x')
        .itemInputs([Item.of('gtceu:glass_lens', 2), Item.of('gtceu:steel_screw', 2), Item.of('gtceu:aluminium_rod', 1), '1x #forge:plates/polyvinyl_chloride'])
    ...
    event.recipes.gtceu.assembler('attachment_tier_scope_advanced_tacz_scope_acog_ta31')
        .itemInputs([Item.of('gtceu:glass_lens', 2), Item.of('gtceu:steel_screw', 2), Item.of('gtceu:stainless_steel_rod', 1), '2x #forge:plates/polytetrafluoroethylene', '1x #gtceu:circuits/hv'])
    ...
    event.recipes.gtceu.assembler('attachment_tier_laser_light_tacz_laser_compact')
        .itemInputs([Item.of('gtceu:glass_lens', 1), Item.of('gtceu:steel_screw', 1), '1x #forge:plates/polyvinyl_chloride', '1x #gtceu:circuits/mv'])
