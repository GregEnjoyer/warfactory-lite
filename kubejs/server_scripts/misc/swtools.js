...
.EUt(128)
    ...
    event.recipes.gtceu.assembler("gregtech:superbwarfare_iff")
    .itemInputs(Item.of('gtceu:basic_electronic_circuit'), Item.of('gtceu:steel_plate'))
    .itemOutputs(Item.of('superbwarfare:iff', 1))
    .circuit(24)
    .duration(100)
    .EUt(32)
})
