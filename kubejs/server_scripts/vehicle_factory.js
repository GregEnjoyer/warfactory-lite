...
ServerEvents.recipes(event => {
    ...
    const VEHICLES = [
        ...
        { entity: 'superbwarfare:ah_6',           factory: 'helicopter_assembler', items: [['kubejs:mv_air_frame', 1], ['superbwarfare:wheel', 3], ['kubejs:mv_engine', 1], ['gtceu:copper_single_cable', 32], ['kubejs:mv_cockpit', 1], ['kubejs:mv_weapons_system', 1], ['kubejs:mv_rotor', 2]], circuit: 2, eut: 120, duration: 400, research: 'air_ah_6' },
        // MH-60M Black Hawk — HV rotary transport/gunship (ashvehicle entity).
        { entity: 'ashvehicle:mh_60m',            factory: 'helicopter_assembler', items: [['kubejs:hv_air_frame', 1], ['superbwarfare:wheel', 3], ['kubejs:hv_engine', 1], ['gtceu:gold_single_cable', 32], ['kubejs:hv_rotor', 2], ['kubejs:hv_weapons_system', 1], ['kubejs:hv_cockpit', 1]], circuit: 20, eut: 450*4, duration: 6000, research: 'air_mh_60' },
        // Mi-28 Attack Helicopter — EV rotary tank-hunter: rotor + a 30mm cannon barrel + a missile weapons station.
        { entity: 'superbwarfare:mi_28',          factory: 'helicopter_assembler', items: [['kubejs:ev_air_frame', 1], ['superbwarfare:wheel', 3], ['kubejs:ev_engine', 1], ['gtceu:aluminium_single_cable', 32], ['kubejs:ev_rotor', 2], ['kubejs:ev_weapons_system', 1], ['kubejs:ev_cannon_barrel', 1], ['kubejs:ev_cockpit', 1]], circuit: 21, eut: 450*4*4, duration: 6000, research: 'air_mi_28' },
        ...
        { entity: 'superbwarfare:a_10a',          factory: 'light_plane_assembler', items: [['kubejs:hv_air_frame', 1], ['superbwarfare:wheel', 3], ['kubejs:hv_engine', 1], ['gtceu:gold_single_cable', 32], ['kubejs:hv_wing', 2], ['kubejs:hv_weapons_system', 1],['kubejs:hv_cockpit', 1]],circuit: 1, eut: 450, duration: 6000, research: 'air_a_10' },
