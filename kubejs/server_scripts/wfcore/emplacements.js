...
ServerEvents.recipes(event => {
    ...
    const EMPLACEMENTS = [
        ...
        { rid: 'kubejs:emp_ciws', research: 'emp_ciws', out: container('superbwarfare:hpj_11'),
          ...
          inputs: [['gtceu:double_steel_plate', 6], ['kubejs:mv_weapons_system', 1], ['gtceu:good_electronic_circuit', 2], ['superbwarfare:seeker', 2]] },
        ...
        { rid: 'kubejs:emp_tow', research: 'emp_tow', out: Item.of('superbwarfare:tow_deployer'),
          ...
          inputs: [['gtceu:double_steel_plate', 4], ['superbwarfare:missile_engine', 2], ['superbwarfare:seeker', 1], ['gtceu:basic_integrated_circuit', 1]] },
        ...
        { rid: 'kubejs:emp_bl_132', research: 'emp_bl_132', out: container('superbwarfare:bl_132'),
          ...
          inputs: [['gtceu:double_steel_plate', 8], ['kubejs:hv_cannon_barrel', 1], ['superbwarfare:cannon_core', 1], ['gtceu:basic_integrated_circuit', 2]] },
        ...
        { rid: 'kubejs:emp_mk_42', research: 'emp_mk_42', out: container('superbwarfare:mk_42'),
          ...
          inputs: [['gtceu:double_steel_plate', 12], ['kubejs:ev_cannon_barrel', 2], ['superbwarfare:cannon_core', 2], ['gtceu:good_integrated_circuit', 2]] },
    ...
    EMPLACEMENTS.forEach(e => {
        event.recipes.gtceu.assembler(e.rid)
            .itemInputs(e.inputs.map(it => Item.of(it[0], it[1])))
            .itemOutputs(e.out)
            .circuit(e.circuit)
            .duration(e.duration)
            .EUt(e.eut)
