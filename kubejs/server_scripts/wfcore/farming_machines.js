...
ServerEvents.recipes(event => {
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_wheat')
        .itemInputs('minecraft:wheat_seeds', 'gtceu:fertilizer')
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_carrot')
        .itemInputs('minecraft:carrot', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_potato')
        .itemInputs('minecraft:potato', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_beetroot')
        .itemInputs('minecraft:beetroot_seeds', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_melon')
        .itemInputs('minecraft:melon_seeds', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_pumpkin')
        .itemInputs('minecraft:pumpkin_seeds', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_sugarcane')
        .itemInputs('minecraft:sugar_cane', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_cocoa')
        .itemInputs('minecraft:cocoa_beans', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
    ...
    event.recipes.wfcore.greenhouse('kubejs:greenhouse_netherwart')
        .itemInputs('minecraft:nether_wart', 'gtceu:fertilizer')
        .inputFluids(Fluid.of('minecraft:water', 100))
        .duration(200)
        .EUt(30)
